...
import { DashboardSummaryCards } from './admin/DashboardSummaryCards';
import { TaskStatusChart } from './admin/TaskStatusChart';
import { TaskPriorityChart } from './admin/TaskPriorityChart';
import { RecentTasksList } from './admin/RecentTasksList';
import { TeamPerformanceChart } from './admin/TeamPerformanceChart';
  ...
  return (
    <div className="space-y-6">
      ...
      <DashboardSummaryCards 
        ...
        usersLength={0} // Will be updated when we fetch users
